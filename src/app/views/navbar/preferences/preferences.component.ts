...
import { logOutOutline, personOutline, lockClosedOutline, moonOutline, languageOutline, notificationsOutline, mailOutline, helpOutline } from 'ionicons/icons'; 
...
export default class PreferencesComponent  implements OnInit {
  ...
  constructor() { 
    addIcons({logOutOutline, personOutline, lockClosedOutline, moonOutline, languageOutline, notificationsOutline, mailOutline, helpOutline});
  }
